...
class JsonRpcClient {
    ...
    async getTransactionCount(address, blockNumber) {
        return this._perform("eth_getTransactionCount", [ethereumjs_util_1.bufferToHex(address), output_1.numberToRpcQuantity(blockNumber)], input_1.rpcQuantity, () => blockNumber);
    }
